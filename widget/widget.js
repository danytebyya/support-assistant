(function (global) {
  ...
  const css = `
    ...
    *{box-sizing:border-box}.fab{position:fixed;right:22px;bottom:22px;width:60px;height:60px;border:0;border-radius:var(--button-radius);background:var(--lime);color:#fff;cursor:pointer;display:grid;place-items:center;opacity:1;transform:scale(1);transition:background-color .2s,opacity .16s ease,transform .24s ease;z-index:2147483647}.fab:hover{background:var(--lime-hover)}svg{width:24px;fill:none;stroke:currentColor;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}.fab img{width:24px;height:24px}.send img{width:19px;height:19px}.header-action img{width:16px;height:16px;filter:brightness(0) invert(1)}.header-action img,.header-action svg{transition:transform .14s ease}.header-action:active img,.header-action:active svg{transform:scale(.78)}.logo img{width:24px;height:24px}img{display:block;object-fit:contain}
    ...
    form{padding:13px;background:var(--footer-bg);border-top:var(--border);display:flex;gap:9px;align-items:flex-end}textarea{font:inherit;resize:none;height:43px;min-height:43px;max-height:calc(4.35em + 24px);overflow-y:hidden;flex:1;border:var(--border);border-radius:var(--button-radius);padding:11px 12px;outline:0;background:var(--input-bg);color:var(--dark);caret-color:var(--lime)}textarea::placeholder{color:var(--muted)}textarea:focus{border-color:#888f8b}.send{width:43px;height:43px;border:0;border-radius:var(--button-radius);background:var(--lime);display:grid;place-items:center;cursor:pointer;transition:background-color .2s}.send:hover:not(:disabled){background:var(--lime-hover)}.send:disabled{opacity:.45;cursor:default}.send svg{width:19px}
    .note{padding:0 16px 10px;background:var(--footer-bg);color:var(--note);font-size:10px;text-align:center}.note a{color:inherit;text-decoration:underline;text-underline-offset:2px;transition:color .18s}.note a:hover{color:var(--link)}
    .coach{position:fixed;right:22px;bottom:96px;width:390px;padding:19px;border-radius:var(--radius);background:var(--coach-bg);color:#132019;box-shadow:var(--coach-shadow);z-index:2147483647}.coach:after{content:"";position:absolute;right:22px;bottom:-8px;width:16px;height:16px;background:var(--coach-bg);transform:rotate(45deg)}.coach b{display:block;margin-bottom:6px;font-size:14px;color:var(--coach-title)}.coach span{display:block;font-size:14px;line-height:1.45;color:var(--coach-text)}.coach-action{position:relative;width:100%;margin-top:14px;padding:8px 15px;border:0;border-radius:var(--button-radius);background:var(--lime);color:#fff;font:inherit;font-weight:500;cursor:pointer;transition:background-color .18s}.coach-action:hover{background:var(--lime-hover)}.coach-backdrop{position:fixed;inset:0;background:#09140c66;z-index:2147483645}
    @media(max-width:768px){.panel{inset:0;width:100vw;height:100dvh;max-height:none;border:0;clip-path:inset(0);transform:scale(.08);transform-origin:calc(100% - 45px) calc(100% - 45px)}.panel.open{transform:scale(1);border-radius:0;clip-path:inset(0)}.fab{right:15px;bottom:15px}.coach{right:14px;bottom:88px;width:calc(100vw - 28px)}header{padding-top:max(18px,env(safe-area-inset-top))}}
    @media(prefers-color-scheme:dark){:host{color-scheme:dark;--dark:#f1f4f2;--muted:#929c96;--surface:#000;--footer-bg:#000;--message-bg:#15171a;--input-bg:#1d211e;--action-bg:#2a302c;--action-hover:#353c37;--action-text:#f1f4f2;--link:#7fd18a;--note:#919a94;--tooltip-bg:#272c29;--tooltip-text:#f5f7f6;--coach-bg:#181b19;--coach-title:#20b845;--coach-text:#e0e5e2;--coach-shadow:0 20px 60px #000000a6;--typing:#9aa49d;--border-color:#373d39;--shadow:0 20px 60px #00000080}.header-action:after{box-shadow:0 5px 18px #0008}.coach-backdrop{background:#03060499}}
