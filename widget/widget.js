  ...
  function init(config) {
    ...
    const toggle = () => {
      ...
      if (open) {
        ...
        state.ui.panel.style.removeProperty("--chat-width");
        state.ui.panel.style.removeProperty("--chat-top");
        state.ui.panel.style.removeProperty("--chat-left");
        scrollToBottom();
      }
    };
