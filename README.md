...
Для полного обновления с официальной страницы и немедленной перестройки индекса
...
Если `faq.json` отредактирован вручную или заменён другим совместимым файлом,
также одной командой перестройте индекс: `make reindex`.
