...
DOWNLOAD_RE = re.compile(
    ...
    r"приложен\w*.{0,25}(?:на|для|под)\s+(?:айфон\w*|айпад\w*|ios|iphone|ipad|android|андроид|телефон\w*|смартфон\w*|пк|компьютер\w*|ноутбук\w*|windows|виндовс|тв|tv|приставк\w*|телевизор\w*|smart|самсунг|samsung|lg|хуавей|huawei)",
    re.I,
)
